      ...
      <div className="bodySubDiv">
        <div>
          ...
          <h1 className="bodyHead">
            {" "}
            Welcome to <br /> GDSC SNU{" "}
          </h1>
          <p className="bodyText">
            Google Developer Student Club (GDSC) is a Google Developers program
            for university students to learn web, mobile, and google
            technologies in a peer-to-peer learning environment.
          </p>
          <a
            className="bodyLink"
            href="https://gdsc.community.dev/sister-nivedita-university-kolkata/"
            target="_blank"
            rel="noreferrer"
          >
            {" "}
